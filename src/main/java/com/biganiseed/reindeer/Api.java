...
//}
	...
	static public boolean checkVersion(Context context) throws Exception{
    	...
    	String actionURL = Const.getRootHttp(context) + "/account/app_version.json?"+Tools.getClientParameters(context);
...
//			}
	...
	static public void terms(final Context context){
		String url = Const.getRootHttp(context) + "/terms_" + Tools.getZHorEN() + ".html";
