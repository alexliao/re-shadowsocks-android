...
public class GeneralHash
{
   ...
   static public long PJWHash(String str)
   {
   ...
   static public long ELFHash(String str)
   {
      long hash = 0;
      long x    = 0;
   ...
   static public long DEKHash(String str)
   {
   ...
   static public long BPHash(String str)
   {
      long hash = 0;
   ...
   static public long FNVHash(String str)
   {
